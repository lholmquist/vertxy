...
----
$ git clone git@github.com:lholmquist/vertxy
...
. Stop your booster.
. Make your change (e.g. edit link:https://github.com/lholmquist/vertxy/edit/master/src/main/resources/webroot/index.html[`src/main/resources/webroot/index.html`]).
